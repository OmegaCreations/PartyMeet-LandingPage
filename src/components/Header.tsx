			...
			<div className={toggle ? 'navbar-menu relative z-50' : 'navbar-menu relative z-50 hidden'}>
				...
				<nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
					...
					<div className="mt-auto">
						<div className="pt-6">
							<a className="block px-4 py-[12px] mb-3 leading-loose text-xs text-center font-semibold leading-none bg-gray-50 hover:bg-gray-100" href="#">Zaloguj się</a>
							<a className="flex items-center justify-center py-[12px] hover:py-[10px] mb-2 leading-loose text-xs text-white font-semibold bg-[#E77C40] hover:bg-[#FAFAFA] hover:text-[#E77C40] hover:border-2 hover:border-[#E77C40] transition duration-200" href="#">Zarejestruj się!&emsp;<BsArrowRightShort size={16} fontWeight={700}/></a>
						</div>
